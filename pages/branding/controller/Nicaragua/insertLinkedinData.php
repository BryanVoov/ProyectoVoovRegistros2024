...
if (isset($_POST['insertLinkedinData'])) {
    ...
    $sql = "INSERT INTO linkedinNic (fecha, pageViews, uniqueVisitors, totalFollowers, newFollowers, nPosts, totalInteractions) 
    VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        header("location: /adminvoov/pages/branding/vista/Nicaragua/linkedin.php");
        exit();
    } else {
