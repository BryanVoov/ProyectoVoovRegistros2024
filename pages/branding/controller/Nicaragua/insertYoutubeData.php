...
if (isset($_POST['insertYoutubeData'])) {
    ...
    $sql = "INSERT INTO youtubeNic (fecha, totalSubscribers, newSubscribers, nVideos, totalViews) 
    VALUES (?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        header("location: /adminvoov/pages/branding/vista/Nicaragua/youtube.php");
        exit();
    } else {
