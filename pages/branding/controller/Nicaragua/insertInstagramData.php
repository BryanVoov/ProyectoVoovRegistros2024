...
if (isset($_POST['insertInstagramData'])) {
    ...
    $sql = "INSERT INTO instagramNic (fecha, reach, profileVisits, totalInteractions, totalFollowers, newFollowers, nPosts) 
    VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        header("location: /adminvoov/pages/branding/vista/Nicaragua/instagram.php");
        exit();
    } else {
