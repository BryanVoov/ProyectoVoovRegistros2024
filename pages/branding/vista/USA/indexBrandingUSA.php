...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/adminvoov/pages/branding/vista/Nicaragua/facebook.php"><i class="fas fa-globe" style="color: #1abc9c;"></i> Web</a>
        <a href="#"><i class="fab fa-facebook" style="color: #3b5998;"></i> Facebook</a>
        <a href="#"><i class="fab fa-instagram" style="color: #e4405f;"></i> Instagram</a>
        <a href="#"><i class="fas fa-users" style="color: #1da1f2;"></i> Threads</a>
        <a href="#"><i class="fab fa-twitter" style="color: #1da1f2;"></i> Twitter</a>
        <a href="#"><i class="fab fa-linkedin" style="color: #0077b5;"></i> LinkedIn</a>
        <a href="#"><i class="fab fa-pinterest" style="color: #bd081c;"></i> Pinterest</a>
    </div>
