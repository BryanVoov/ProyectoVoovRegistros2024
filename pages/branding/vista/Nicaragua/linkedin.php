...
<div class="container mt-4">
        ...
        <div id="dataDisplay" class="mt-4">
            ...
            $sqlMonths = "SELECT DISTINCT DATE_FORMAT(fecha, '%b-%Y') as month FROM  linkedinnic";
            if ($fromDate && $toDate) {
            ...
            $metrics = [
                "Page Views (LinkedIn)" => "pageViews",
                "Unique Visitors (LinkedIn)" => "uniqueVisitors",
                "Total Followers (Metricool)" => "totalFollowers",
                "New Followers (Metricool)" => "newFollowers",
            ...
            foreach ($metrics as $label => $column) {
                $sqlData = "SELECT DATE_FORMAT(fecha, '%b-%Y') as month, SUM({$column}) as total FROM  linkedinnic";
                if ($fromDate && $toDate) {
    ...
    <script src="charts/chartInitLinkedin.js"></script>
