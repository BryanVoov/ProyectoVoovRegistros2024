...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/adminvoov/pages/branding/vista/Nicaragua/google.php"><i class="fab fa-google" style="color: red;"></i> Google</a>
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="enterDataForm" method="post" action="/adminvoov/pages/branding/controller/Nicaragua/insertGoogleData.php">
                    <div class="form-group">
                        <label for="fecha">Register Date</label>
                        <input type="month" class="form-control" id="fecha" name="fecha" required>
                    </div>
                    <div class="form-group">
                        <label for="paidImpressions">Paid Impressions</label>
                        <input type="number" class="form-control" id="paidImpressions" name="paidImpressions" required>
                    </div>
                    <div class="form-group">
                        <label for="organicImpressions">Organic Impressions</label>
                        <input type="number" class="form-control" id="organicImpressions" name="organicImpressions" required>
                    </div>
                    <div class="form-group">
                        <label for="clics">Clics</label>
                        <input type="number" class="form-control" id="clics" name="clics" required>
                    </div>
                    <div class="form-group">
                        <label for="CTR">CTR</label>
                        <input type="number" class="form-control" id="CTR" name="CTR" required>
                    </div>
                    <div class="form-group">
                        <label for="CPC">CPC</label>
                        <input type="number" class="form-control" id="CPC" name="CPC" required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary" name="insertGoogleData">Save changes</button>
                    </div>
                </form>
        </div>
...
<div class="container mt-4">
        ...
        <div id="dataDisplay" class="mt-4">
            ...
            $sqlMonths = "SELECT DISTINCT DATE_FORMAT(fecha, '%b-%Y') as month FROM googleNic";
            if ($fromDate && $toDate) {
            ...
            foreach ($metrics as $label => $column) {
                $sqlData = "SELECT DATE_FORMAT(fecha, '%b-%Y') as month, SUM({$column}) as total FROM googleNic";
                if ($fromDate && $toDate) {
    ...
    <script src="charts/chartInitGoogle.js"></script>
