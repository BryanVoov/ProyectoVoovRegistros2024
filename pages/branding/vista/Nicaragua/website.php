...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="enterDataForm" method="post" action="/adminvoov/pages/branding/controller/Nicaragua/insertWebsiteData.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="websiteVisits" name="websiteVisits" required>
                    </div>
                    <div class="form-group">
                        <label for="nVisitors"># of Visitors</label>
                        <input type="number" class="form-control" id="nVisitors" name="nVisitors" required>
                    </div>
                    <div class="form-group">
                        <label for="bounceRate">Bounce Rate</label>
                        <input type="number" class="form-control" id="bounceRate" name="bounceRate" required>
                    </div>
                    
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary" name="insertWebsiteData">Save changes</button>
                    </div>
                </form>
        </div>
...
<div class="container mt-4">
        ...
        <div id="dataDisplay" class="mt-4">
            ...
            $sqlMonths = "SELECT DISTINCT DATE_FORMAT(fecha, '%b-%Y') as month FROM  websiteNic";
            if ($fromDate && $toDate) {
            ...
            foreach ($metrics as $label => $column) {
                $sqlData = "SELECT DATE_FORMAT(fecha, '%b-%Y') as month, SUM({$column}) as total FROM  websiteNic";
                if ($fromDate && $toDate) {
    ...
    <script src="charts/chartInitWebsite.js"></script>  
