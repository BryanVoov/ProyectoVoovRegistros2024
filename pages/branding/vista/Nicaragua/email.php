...
<body>
    ...
    <div class="container-fluid mt-4">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="enterDataForm" method="post" action="/adminvoov/pages/branding/controller/Nicaragua/insertEmailData.php">
        ...
        <div id="dataDisplay" class="mt-4">
            ...
            $sqlMonths = "SELECT DISTINCT DATE_FORMAT(fecha, '%b-%Y') as month FROM emailNic";
            if ($fromDate && $toDate) {
            ...
            foreach ($metrics as $label => $column) {
                $sqlData = "SELECT DATE_FORMAT(fecha, '%b-%Y') as month, SUM({$column}) as total FROM emailNic";
                if ($fromDate && $toDate) {
