...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="enterDataForm" method="post" action="/adminvoov/pages/branding/controller/Nicaragua/insertGMBData.php">
                    ...
                    <div class="form-group">
                        <label for="nPosts"># of posts</label>
                        <input type="number" class="form-control" id="nPosts" name="nPosts" required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary" name="insertGMBData">Save changes</button>
                    </div>
                </form>
        </div>
...
<div class="container mt-4">
        ...
        <div id="dataDisplay" class="mt-4">
            ...
            $sqlMonths = "SELECT DISTINCT DATE_FORMAT(fecha, '%b-%Y') as month FROM gmbNic";
            if ($fromDate && $toDate) {
            ...
            foreach ($metrics as $label => $column) {
                $sqlData = "SELECT DATE_FORMAT(fecha, '%b-%Y') as month, SUM({$column}) as total FROM gmbNic";
                if ($fromDate && $toDate) {
    ...
    <script src="charts/chartInitGMB.js"></script>
