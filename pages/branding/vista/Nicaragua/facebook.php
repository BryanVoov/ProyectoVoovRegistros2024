...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="enterDataForm" method="post" action="/adminvoov/pages/branding/controller/Nicaragua/insertFacebookData.php">
                            ...
                            <div class="form-group">
                                <label for="pageVisits">Page Visits (MetriCool)</label>
                                <input type="number" class="form-control" id="pageVisits" name="pageVisits" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="totalFans">Total Fans (MetriCool)</label>
                                <input type="number" class="form-control" id="totalFans" name="totalFans" required>
                            </div>
                            <div class="form-group">
                                <label for="newFans">New Fans (MetriCool)</label>
                                <input type="number" class="form-control" id="newFans" name="newFans" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" name="insertFacebookData">Save changes</button>
                            </div>
                        </form>
                </div>
    ...
    <div class="container mt-4">
        ...
        <div id="dataDisplay" class="mt-4">
            ...
            $sqlMonths = "SELECT DISTINCT DATE_FORMAT(fecha, '%b-%Y') as month FROM facebookNic";
            if ($fromDate && $toDate) {
            ...
            $metrics = [
                "Reach (Meta)" => "reach",
                "Page Visits (MetriCool)" => "pageVisits",
                "Total Interactions (MetriCool)" => "totalInteractions",
                "Total Fans (MetriCool)" => "totalFans",
                "New Fans (MetriCool)" => "newFans",
            ...
            foreach ($metrics as $label => $column) {
                $sqlData = "SELECT DATE_FORMAT(fecha, '%b-%Y') as month, SUM({$column}) as total FROM facebookNic";
                if ($fromDate && $toDate) {
    ...
    <script src="charts/chartInitFacebook.js"></script>
