...
if (isset($_GET['idAsociadoVA']))
{
    ...
    $query = "SELECT * FROM asociadoVA WHERE idAsociadoVA = $idAsociadoVA";
    ...
    if(isset($_POST['update'])){
        ...
        $query = "UPDATE asociadoVA set nombreAsociado = '$nombreAsociado', cedula = '$cedula', 
        ...
        horarioSalida = '$horarioSalida', tipoContrato = '$tipoContrato', fechaTerminacion = '$fechaTerminacion', foto = ? WHERE idAsociadoVA = $idAsociadoVA";
        ...
        header("Location: /adminvoov/pages/asociadoVA/vista/verAsociadosVA.php");
