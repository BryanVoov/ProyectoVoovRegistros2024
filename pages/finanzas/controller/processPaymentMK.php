...
// Insert data into pagosAsociadoMK table
$sql = "INSERT INTO pagosAsociadoMK (idAsociadoMK, idCliente, fecha, salario, costosAdministrativos, costoSupervisor, costoManagement) 
        VALUES (?, ?, ?, ?, ?, ?, ?)";
...
// Bind the parameters
$stmt->bind_param("iissddd", $idAsociadoMK, $idCliente, $fecha, $salario, $costosAdministrativos, $costoSupervisor, $costoManagement);
