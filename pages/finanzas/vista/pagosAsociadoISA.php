  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>ISA ASSOCIATES PAYMENTS</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">ISA Associates Payments</li>
            </ol>
...
if (!empty($idAsociadoISA)) {
    ...
    echo "<p>No idAsociadoISA found in the URL.</p>";
}

// Fetch the associate's name based on the idAsociadoISA
if ($idAsociadoISA > 0) {
    $sql = "SELECT nombreAsociado FROM asociadoISA WHERE idAsociadoISA = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("i", $idAsociadoISA);
    $stmt->execute();
    $result = $stmt->get_result();
...
<div class="container">
    ...
    <form action="/adminvoov/pages/finanzas/controller/processPaymentISA.php" method="post">
        <input type="hidden" name="idAsociadoISA" value="<?php echo htmlspecialchars($idAsociadoISA); ?>">
    ...
    <div class="card mt-5">
        <div class="card-header">
            <form method="get" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="row mb-0">
                ...
                <div class="form-group col-md-2">
                    <label>&nbsp;</label>
                    <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . '?idAsociadoISA=' . htmlspecialchars($idAsociadoISA); ?>" class="btn btn-secondary btn-block">Reset Filters</a>
                </div>
            </form>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT p.fecha AS fechaPago, 
                                ...
                                FROM pagosAsociadoISA p
                                JOIN cliente c ON p.idCliente = c.idCliente
                                WHERE p.idAsociadoISA = ?";
