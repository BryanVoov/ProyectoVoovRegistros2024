  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>VA ASSOCIATES PAYMENTS</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">VA Associates Payments</li>
            </ol>
...
// Get the idAsociadoVA from the URL
$idAsociadoVA = isset($_GET['idAsociadoVA']) ? $_GET['idAsociadoVA'] : '';
$nombreAsociado = '';
echo "<p>idAsociadoVA from URL: $idAsociadoVA</p>";

// Fetch clients related to the associate
$clientNames = [];
if (!empty($idAsociadoVA)) {
    ...
    echo "<p>No idAsociadoVA found in the URL.</p>";
}

// Fetch the associate's name based on the idAsociadoVA
if ($idAsociadoVA > 0) {
    $sql = "SELECT nombreAsociado FROM asociadoVA WHERE idAsociadoVA = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("i", $idAsociadoVA);
    $stmt->execute();
    $result = $stmt->get_result();
...
<div class="container">
    ...
    <form action="/adminvoov/pages/finanzas/controller/processPaymentVA.php" method="post">
        <input type="hidden" name="idAsociadoVA" value="<?php echo htmlspecialchars($idAsociadoVA); ?>">
    ...
    <div class="card mt-5">
        <div class="card-header">
            <form method="get" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="row mb-0">
                ...
                <div class="form-group col-md-2">
                    <label>&nbsp;</label>
                    <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . '?idAsociadoVA=' . htmlspecialchars($idAsociadoVA); ?>" class="btn btn-secondary btn-block">Reset Filters</a>
                </div>
            </form>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT p.fecha AS fechaPago, 
                                ...
                                FROM pagosAsociadoVA p
                                JOIN cliente c ON p.idCliente = c.idCliente
                                WHERE p.idAsociadoVA = ?";
