...
if (isset($_GET['idAsociadoISA']))
{
    ...
    $query = "SELECT * FROM asociadoISA WHERE idAsociadoISA = $idAsociadoISA";
    ...
    if(isset($_POST['update'])){
        ...
        $costoCliente = $_POST['costoCliente'];
        ...
        $query = "UPDATE asociadoISA set nombreAsociado = '$nombreAsociado', cedula = '$cedula', 
        ...
        estadoActividad = '$estadoActividad', cargoCliente = '$cargoCliente', numeroEmpleado = '$numeroEmpleado', costoCliente = '$costoCliente', horarioEntrada = '$horarioEntrada', 
        horarioSalida = '$horarioSalida', tipoContrato = '$tipoContrato', fechaTerminacion = '$fechaTerminacion', foto = ? WHERE idAsociadoISA = $idAsociadoISA";
        ...
        header("Location: /adminvoov/pages/asociadoISA/vista/verAsociadosISA.php");
    }
