  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>MARKETING ASSOCIATES</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">MARKETING ASSOCIATES</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<?php if(isset($_SESSION['message'])){ ?>
    ...
    <div class="card">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-right">
                        <a class="btn btn-primary btn-sm" href="#" onclick="verAsociado(<?php echo $row['idAsociadoMK']; ?>)">
                            <i class="fas fa-folder"></i>
                        </a>
                        <a class="btn btn-info btn-sm" href="#" onclick="confirmEdit(<?php echo $row['idAsociadoMK']; ?>)">
                            <i class="fas fa-pencil-alt"></i>
                        </a>
                        <a class="btn btn-danger btn-sm" href="#" onclick="confirmDeletion(<?php echo $row['idAsociadoMK']; ?>)">
        ...
        <script>
function confirmEdit(idAsociadoMK) {
    if (confirm('Do you want to edit this register?')) {
        window.location.href = 'asociadoEdit.php?idAsociadoMK=' + idAsociadoMK;
    }
}
</script></b>
        
        <script>
function confirmDeletion(idAsociadoMK) {
    if (confirm('Are you sure you want to delete this register?')) {
        window.location.href = '../controller/eliminarAsociado.php?idAsociadoMK=' + idAsociadoMK;
    }
}
</script></b>

<script>
function verAsociado(idAsociadoMK) {
