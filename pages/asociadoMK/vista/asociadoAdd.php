...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <li class="nav-item">
      <a href="../vista/verasociadosMK.php" class="nav-link">
        <i class="far fa-circle nav-icon"></i>
        <p>All Associates</p>
      </a>
    </li>
    ...
    <section class="content">
      <div class="row">
        ...
        <!-- MALDITA ALERTA QUE ME COSTO UN DIA HACER TE ODIO -->
          <div class="card card-primary">
            ...
            <form action="/adminvoov/pages/asociadoMK/controller/agregarAsociado.php" method ="POST" enctype="multipart/form-data">
            <div class="card-body">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" name = "../controller/agregarAsociado"value="Add Associate" class="btn btn-success float-right">
