...
<?php if(isset($_SESSION['message'])){ ?>
    ...
    <form action="añadirSupervisor.php" method="POST">
        <div class="card-body">
            <div class="form-group">
                <label>Supervisor Name</label>
                <input type="text" name="nombreSupervisor" class="form-control" required>
            </div>
            <div class="form-group">
                <label>Department</label>
                <select class="form-control custom-select" name="departamento" required>
