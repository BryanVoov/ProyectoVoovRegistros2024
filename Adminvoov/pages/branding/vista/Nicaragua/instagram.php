...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="enterDataForm" method="post" action="/adminvoov/pages/branding/controller/Nicaragua/insertInstagramData.php">
                            <div class="form-group">
                                <label for="fecha">Register Date</label>
                                <input type="month" class="form-control" id="fecha" name="fecha" required>
                            </div>
                            <div class="form-group">
                                <label for="reach">Reach (Meta)</label>
                                <input type="number" class="form-control" id="reach" name="reach" required>
                            </div>
                            <div class="form-group">
                                <label for="profileVisits">Profile Visits (MetriCool)</label>
                                <input type="number" class="form-control" id="profileVisits" name="profileVisits" required>
                            </div>
                            <div class="form-group">
                                <label for="totalInteractions">Total Interactions (MetriCool)</label>
                                <input type="number" class="form-control" id="totalInteractions" name="totalInteractions" required>
                            </div>
                            <div class="form-group">
                                <label for="totalFollowers">Total Followers (MetriCool)</label>
                                <input type="number" class="form-control" id="totalFollowers" name="totalFollowers" required>
                            </div>
                            <div class="form-group">
                                <label for="newFollowers">New Followers (MetriCool)</label>
                                <input type="number" class="form-control" id="newFollowers" name="newFollowers" required>
                            </div>
                            <div class="form-group">
                                <label for="nPosts"># Posts (MetriCool)</label>
                                <input type="number" class="form-control" id="nPosts" name="nPosts" required>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-primary" name="insertInstagramData">Save changes</button>
                            </div>
                        </form>
                </div>
    ...
    <div class="container mt-4">
        ...
        <div id="dataDisplay" class="mt-4">
            ...
            $sqlMonths = "SELECT DISTINCT DATE_FORMAT(fecha, '%b-%Y') as month FROM instagramNic";
            if ($fromDate && $toDate) {
            ...
            $metrics = [
                "Reach (Meta)" => "reach",
                "Profile Visits (MetriCool)" => "pageVisits",
                "Total Interactions (MetriCool)" => "totalInteractions",
                "Total Followers (MetriCool)" => "totalFans",
                "newFollowers" => "newFans",
                "# Posts (MetriCool)" => "nPosts",
            ];
            ...
            foreach ($metrics as $label => $column) {
                $sqlData = "SELECT DATE_FORMAT(fecha, '%b-%Y') as month, SUM({$column}) as total FROM instagramNic";
                if ($fromDate && $toDate) {
    ...
    <script src="charts/chartInitInstagram.js"></script>
