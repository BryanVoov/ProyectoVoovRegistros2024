...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="enterDataForm" method="post" action="/adminvoov/pages/branding/controller/Nicaragua/insertTiktokData.php">
                    <div class="form-group">
                        <label for="fecha">Register Date</label>
                        <input type="month" class="form-control" id="fecha" name="fecha" required>
                    </div>
                    <div class="form-group">
                        <label for="totalFollowers">Total Followers</label>
                        <input type="number" class="form-control" id="totalFollowers" name="totalFollowers" required>
                    </div>
                    <div class="form-group">
                        <label for="newFollowers">Total New Followers</label>
                    ...
                    <div class="form-group">
                        <label for="newLikes">Total New Likes</label>
                        <input type="number" class="form-control" id="newLikes" name="newLikes" required>
                    </div>
                    <div class="form-group">
                        <label for="totalTiktoks">Total Tik Toks</label>
                        <input type="number" class="form-control" id="totalTiktoks" name="totalTiktoks" required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary" name="insertTiktokData">Save changes</button>
                    </div>
                </form>
        </div>
...
<div class="container mt-4">
        ...
        <div id="dataDisplay" class="mt-4">
            ...
            $sqlMonths = "SELECT DISTINCT DATE_FORMAT(fecha, '%b-%Y') as month FROM  tiktokNic";
            if ($fromDate && $toDate) {
            ...
            $metrics = [
                ...
                "Total New Followers" => "newFollowers",
                "Total Views" => "totalViews",
                "Total New Likes" => "newLikes",
                "Total Tik Toks" => "totalTiktoks",
            ];
            ...
            foreach ($metrics as $label => $column) {
                $sqlData = "SELECT DATE_FORMAT(fecha, '%b-%Y') as month, SUM({$column}) as total FROM  tiktokNic";
                if ($fromDate && $toDate) {
    ...
    <script src="charts/chartInitTiktok.js"></script>       
