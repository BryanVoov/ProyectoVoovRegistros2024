...
if (isset($_POST['insertEmailData'])) {
    ...
    $sql = "INSERT INTO emailUSA (fecha, reNewsletterSent, dripEmailSent, nRecipientsRENL, nRecipientsDripEmails, openRateRENL, openRateDripEmails, ctrRENL, ctrDripEmails, linkClicksRENL, linkClicksDripEmails, appointmentEmails) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        header("location: /adminvoov/pages/branding/vista/USA/email.php");
        exit();
    } else {
