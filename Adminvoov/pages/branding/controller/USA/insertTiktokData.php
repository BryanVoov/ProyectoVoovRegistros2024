...
if (isset($_POST['insertTiktokData'])) {
    ...
    $sql = "INSERT INTO tiktokUSA (fecha, totalFollowers, newFollowers, totalViews, newLikes, totalTiktoks) 
    VALUES (?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        header("location: /adminvoov/pages/branding/vista/USA/tiktok.php");
        exit();
    } else {
