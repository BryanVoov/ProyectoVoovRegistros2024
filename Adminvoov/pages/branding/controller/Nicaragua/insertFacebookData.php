...
if (isset($_POST['insertFacebookData'])) {
    ...
    $sql = "INSERT INTO facebookNic (fecha, reach, pageVisits, totalInteractions, totalFans, newFans, nPosts) 
    VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        header("location: /adminvoov/pages/branding/vista/Nicaragua/facebook.php");
        exit();
    } else {
