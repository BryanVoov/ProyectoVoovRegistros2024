...
$departamento = "Inside Sales Associate";
$fotoContenido = null;
...
$sql = "INSERT INTO asociadoISA (nombreAsociado, cedula, telefono, cumple, email, direccion, salarioInicial, fechaContratacionV, fechaContratacionC, estadoActividad, cargoCliente, numeroEmpleado, horarioEntrada, horarioSalida, tipoContrato, departamento, foto) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

$stmt = $conn->prepare($sql);
$stmt->bind_param("ssssssssssssssssb", 
