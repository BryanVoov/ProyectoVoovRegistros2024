...
<?php if(isset($_SESSION['message'])){ ?>
    ...
    <div class="card">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-right">
                        ...
                        <a class="btn btn-info btn-sm" href="#" onclick="confirmEdit(<?php echo $row['idAsociadoISA']; ?>)">
                            <i class="fas fa-pencil-alt"></i>
                        </a>
                        <a class="btn btn-danger btn-sm" href="#" onclick="confirmDeletion(<?php echo $row['idAsociadoISA']; ?>)">
        ...
        <script>
function confirmEdit(idAsociadoISA) {
    if (confirm('Do you want to edit this register?')) {
        window.location.href = 'asociadoEdit.php?idAsociadoISA=' + idAsociadoISA;
    }
}
</script></b>
        
        <script>
function confirmDeletion(idAsociadoISA) {
    if (confirm('Are you sure you want to delete this register?')) {
        window.location.href = '../controller/eliminarAsociado.php?idAsociadoISA=' + idAsociadoISA;
    }
}
</script></b>
