...
<?php if(isset($_SESSION['message'])){ ?>
        ...
        <!-- MALDITA ALERTA QUE ME COSTO UN DIA HACER TE ODIO -->
          <div class="card card-primary">
            ...
            <form action="/adminvoov/pages/cliente/controller/agregarcliente.php" method ="POST" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name ="nombrePropietario"  class="form-control">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" name ="industria"  class="form-control">
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control custom-select"  name = "zonaHoraria">
                  <option selected disabled>Select one</option>
                  <option>Pacific Time Zone (UTC-8)</option>
                  <option>Mountain Time Zone (UTC-7)</option>
                  <option>Central Time Zone (UTC-7)</option>
                  <option>Eastern Time Zone (UTC-5)</option>
                  <option>Atlantic Time Zone (UTC-4)</option>
                </select>
              </div>

              <div class="form-group">
                <label>Correspondence Address</label>
                <textarea  name ="correspondencia" class="form-control" rows="4"></textarea>
              </div>
          ...
          <div class="card-header">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="carpetaCompartida" class="form-control">
              </div>
              <div class="form-group">
                <label>Training Fee</label>
                <input type="number" name="cuotaInstalacion" class="form-control">
              </div>
              
              <div class="form-group">
                <label>Payment Status</label>
                <select class="form-control custom-select"  name = "estadoPago">
                  <option selected disabled>Select one</option>
              ...
              <div class="form-group">
                ...
                <select class="form-control custom-select"  name = "estadoAsignacionPersonal">
                  <option selected disabled>Select one</option>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" name = "agregarcliente"value="Add Customer" class="btn btn-success float-right">
