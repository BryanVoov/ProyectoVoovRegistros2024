        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../cliente/clienteAdd.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cliente</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../cliente/clienteAdd.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Nuevo Cliente</p>
                </a>
              <li class="nav-item">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name ="n_cliente"  class="form-control">              </div>
              <div class="form-group">
                <label>Punto de contacto</label>
                <input type="text" name ="n_contacto"  class="form-control">
              </div>
              <div class="form-group">
                <label>Comentarios Adicionales</label>
                <textarea name="n_comentario" class="form-control" rows="4"></textarea>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
