...
$sql = "INSERT INTO asociadoVA (nombreAsociado, cedula, telefono, cumple, email, direccion, salarioInicial, fechaContratacionV, fechaContratacionC, estadoActividad, cargoCliente, numeroEmpleado, horarioEntrada, horarioSalida, tipoContrato, departamento, foto) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
